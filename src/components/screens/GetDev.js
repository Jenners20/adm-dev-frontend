...
class GetDev extends Component {
    state = {
        data: [],
        modalInsertar: false,
        modalEliminar: false,
    ...
    peticionGet = () => {
        let getdeveloper = 'http://localhost:4000/developer/find/integration/bydate/completado'
    ...
    render() {
        ...
        return (
            ...
            <div className="App">
                <Navbar />
                <br /><br /><br />
                <h1>Lista de comercios completados</h1>
